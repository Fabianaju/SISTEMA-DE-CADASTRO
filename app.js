...
// jsPDF + html2canvas: usados para gerar o PDF baixável (funciona igual em
// computador e celular, sem depender do comportamento do diálogo de impressão).
...
<div class="pr-client-box">
  <div class="pr-cl-full"><span class="pr-cl-label">Nome completo</span>${esc(c.nome)}</div>
